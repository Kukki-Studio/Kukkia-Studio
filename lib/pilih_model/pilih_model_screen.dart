...
class PilihModelScreen extends StatefulWidget {
  const PilihModelScreen({super.key});

  @override
  State<PilihModelScreen> createState() => _PilihModelScreenState();
}
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            height: 80,
            decoration: BoxDecoration(
              color: widget.model.accentColor.withValues(alpha: 0.1),
          ...
          Text(
            _done
                ...
                : 'Tonton iklan singkat untuk membuka model ${widget.model.personality} ini.',
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor:
                    _done ? const Color(0xFF2DC653) : widget.model.accentColor,
                foregroundColor: Colors.white,
                disabledBackgroundColor:
                    widget.model.accentColor.withValues(alpha: 0.5),
...
class _PilihModelScreenState extends State<PilihModelScreen> {
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: Icon(Icons.arrow_back_ios_new,
              color: isDark ? Colors.white : const Color(0xFF212529), size: 18),
          onPressed: () => Navigator.pop(context),
        ),
        title: Text(
          'Pilih Model',
      ...
      body: Column(
        ...
        children: [
          Padding(
            ...
            child: Text(
              'Pilih karakter AI yang akan menemanimu.\nModel terkunci bisa dibuka dengan menonton iklan.',
              style: TextStyle(
                fontSize: 13,
